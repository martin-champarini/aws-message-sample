package com.aws.message.sample.repository;

import com.aws.message.sample.AwsMessageSqsApp;
import com.aws.message.sample.config.Constants;
import com.aws.message.sample.config.audit.AuditEventConverter;
import com.aws.message.sample.domain.PersistentAuditEvent;
...
import static com.aws.message.sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
